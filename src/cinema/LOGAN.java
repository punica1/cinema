...
/**
 	...
 	*
 	*/
public class LOGAN implements ActionListener{
	...
	public	LOGAN(){
		...
		label[0].setText("<html>"+"<br>Please select an available time to watch LOGAN:</html>");
		...
		button[7].setText("Screen3 15:30");
		button[7].setBackground(color);
		button[7].addActionListener(this);
		button[8].setText("Screen3 18:00");
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(tN<t){
        	frame.dispose();
        	new buyTicket().buyTicket("LOGAN",s);

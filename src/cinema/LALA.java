...
/**
 	...
 	*
 	*/
public class LALA implements ActionListener {
	...
	public LALA(){
		...
		label[0].setText("<html>"+"<br>Please select an available time to watch LALA LAND:</html>");
		...
		button[4].setText("Screen2 10:30");
		button[4].setBackground(color);
		button[4].addActionListener(this);
		button[5].setText("Screen2 13:00");
	 ...
	 /**
	   ...
	   */
		...
		public void actionPerformed(ActionEvent e) {
	        ...
	        if(tN<t){
	        	frame.dispose();
	        	new buyTicket().buyTicket("LALA LAND",s);
	        }else{
	        	frame.dispose();
	        	new Error(2).timeErr();

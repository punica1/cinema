...
/**
 	...
 	*
 	*/
public class BEAUTY implements ActionListener {
	...
	public BEAUTY(){
		...
		Font flabel = new Font("Cambria",Font.BOLD,36);
		...
		label[0].setText("<html>"+"<br>Please select an available time to watch BEAUTY AND THE BEAST:</html>");
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(tN<t){
        	frame.dispose();
        	new buyTicket().buyTicket("BEAUTY AND THE BEAST",s);
        }else{
        	frame.dispose();
        	new Error(5).timeErr();
        }
